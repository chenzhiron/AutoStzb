...
from modules.general.option_verify_area import zhaomu_area, shili_click, zhengbing_page_verify_area, click_list_x_y, \
    ...
    address_area_start, queding_area_xy, retreat_click_area, retreat_click_area_xy
...
# 战报内部点击战斗地点
click_battle_retreat = ClickOperatorSteps(0, None, battle_site[0], battle_site[1])
...
# 点击撤退
click_battle_active = ClickOperatorSteps(retreat_click_area, ['撤退'], retreat_click_area_xy[0], retreat_click_area_xy[1])
# 二次确定点击撤退按钮
...
# 下一个标记
click_next_sign = ClickOperatorSteps((880, 225, 1050, 285), None, 0, 0)
