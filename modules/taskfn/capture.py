...
from modules.utils import truncated_normal, find_top_template_matches
...
class Capture(Basic):
    ...
    def execute(self):
        steps_fn = [self.execute_draft, self.execute_search_map, self.execute_operation_go_map,
                    self.execute_list_action]


if __name__ == '__main__':
    capture = Capture(operator=DeviceOperator(DeviceManager('127.0.0.1:16384')), config={})
    capture.execute_list_action_result()
